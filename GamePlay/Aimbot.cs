...
public class Aimbot : MonoBehaviour
{
    ...
    public RotationChanges TrackTarget()
    {
        ...
        var dx = CalculateDeltaRotationDegrees(totalVerticalRotationAngles, timeToAim, Time.deltaTime*speed, targetPos);
        var dy = CalculateDeltaRotationDegrees(totalHorizontalRotationAngles, timeToAim, Time.deltaTime*speed, targetPos);
    ...
    private Transform SelectTarget()
    {
        ...
        if (Physics.SphereCast(startPoint, aimAssistRadius, direction, out var hit, 1000f,Targetlayer))
        {

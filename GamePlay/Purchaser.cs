...
namespace CompleteProject
{
    ...
    public class Purchaser : MonoBehaviour
    {
        ...
        public static string kProductIDConsumable1 = "com.gameblinders.gbs.critical.encounter.terrorist.shooting.arena.gold10000";
        public static string kProductIDConsumable2 = "com.gameblinders.gbs.critical.encounter.terrorist.shooting.arena.gold25000";
        public static string kProductIDNonConsumable = "com.gameblinders.gbs.critical.encounter.terrorist.shooting.arena.removeads";
        ...
        void Start()
        {
            ...
            //if (GameManager.Instance.Gamedata.isRemoveAds == false)
            //{
            //    CheckPurchases();
            //}
        }
...
//                Universal.Purchased = true;
                ...
                StringComparison.Ordinal))
            {
              ...
              //  GameManager.Instance.Gamedata.isRemoveAds = true;
             //   PlayerDataHandler.Instance.Save();
               // AdsManager.instance.removeAds = GameManager.Instance.Gamedata.isRemoveAds;
                AdsManager.instance.RemoveBanner();
//                ManuHandler.Instance.promoIcon.SetActive(false);
            //    ManuHandler.Instance.RemoveAdPopup.SetActive(false);
                
               // ManuHandler.Instance.CloseSubMenu();
//                Store.instance.removeAdsButton.interactable = false;

               // print("isRemoveAds = " + GameManager.Instance.Gamedata.isRemoveAds);
...
//            {
//                Gamemanager.isRemoveAds = true;
//                PlayerDataController.Instance.Save();
//                AdsManager.instance.removeAds = Gamemanager.isRemoveAds;
//                AdsManager.instance.RemoveBanner();
//                Store.instance.removeAdsButton.interactable = false;
//            }
//#endif
